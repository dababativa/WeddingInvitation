...
SECRET_KEY = "django-insecure-22zhwu!p(h5v#c%h8kp%o52&u*$ook6_4#q9%rj19dhla5cwf="
...
ALLOWED_HOSTS = [
    "127.0.0.1",
    "localhost",
    "babativa.pythonanywhere.com",
    "bodalauraydaniel.info",
    "www.bodalauraydaniel.info",
]
...
INSTALLED_APPS = [
    # My apps
    "invitations.apps.InvitationsConfig",  # "invitations
    # Django apps
